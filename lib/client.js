...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		__molbio_modules["build/client-entry.mjs"] = () => {
			...
			const { LIBRARY_FILE, childPath, classifyEntry, decodeBase64Bytes, filterPapers, libraryTags, logoSvg, paperFields, paperLink, paperSummary, parseAlignmentFile, parseLibrary, parsePlasmidFile, plasmidSvg, readWorkspaceText, sortEntries } = __molbio_require("build/panel-core.mjs");
